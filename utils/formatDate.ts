...
export function formatDate(date: number | Date, formatString?: string): string
export function formatDate(date?: null | undefined | string | number, formatString?: string): undefined
