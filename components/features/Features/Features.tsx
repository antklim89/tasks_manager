    ...
    return (
        <section className='container '>
            <div className='flex flex-row gap-1 md:gap-4 mb-1 md:mb-4 flex-wrap'>
                <div className='w-full flex-1 border border-primary rounded-lg p-4 basis-96'>
                ...
                <div className='w-full flex-[2] border border-primary rounded-lg p-4 basis-96 flex'>
